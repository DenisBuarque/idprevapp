        ...
        <form method="POST" action="{{ route('admin.documents.store') }}" enctype="multipart/form-data"
            ...
            <div class="card card-info" style="max-width: 900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro modelo de documento:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group m-0">
                                <small>Ação previdenciária:</small>
                                <select name="action_id" class="form-control @error('action_id') is-invalid @enderror">
                                    <option value=""></option>
