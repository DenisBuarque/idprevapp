...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.actions.index') }}" class="btn btn-md btn-info" title="Adicionar novo registro">
            Listar registros
        </a>
    </div>
@stop
...
@section('content')
    <div class="container-fluid">
        ...
        <form method="POST" action="{{route('admin.actions.store')}}" onsubmit="return mySubmit()">
            @csrf
            <div class="card card-info" style="max-width:900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de ação previdenciária:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
