...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.worksheets.update', ['id' => $worksheet->id]) }}" enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <small>Título:</small>
                                <input type="text" name="title" value="{{ $worksheet->title ?? old('title') }}"
