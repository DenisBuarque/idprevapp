...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.testimonials.update', ['id' => $testimonial->id]) }}"
            enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            @method('PUT')
            <div class="card card-info" style="max-width: 900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário edição de testemunha:</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="Digite aqui as exigencias.">{{ $testimonial->description ?? old('description') }}</textarea>
                            </div>
                        </div>
