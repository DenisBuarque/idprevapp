                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                            ...
                            <input type="text" name="login" id="login" value="{{ $administrative->login ?? old('login') }}" class="form-control @error('login') is-invalid @enderror"
                                maxlength="100" />
                                @error('login')
                                    <div class="text-red">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-sm-12">
                        <input type="checkbox" name="reminder" value="true" @if ($administrative->reminder) checked @endif  /> Adicionar registro aos lembretes de data de cessação.
                    </div>
                </div>
