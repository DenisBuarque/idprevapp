...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($type_user == "A"){
            ...
            $leads = $this->lead->whereIn('situation',[1,2,4,5])->where('tag',3)->orderBy('id','DESC')->get();
        }else {
            // conta os registros
            ...
            // consulta os registros
            $leads = $this->lead->whereIn('situation',[1,2,4,5])->where('user_id',auth()->user()->id)->where('tag',3)->orderBy('id','DESC')->get();
        }
